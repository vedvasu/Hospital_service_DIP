...
def bot_path_all_different(cx1,cy1,d):
    ...
    cy1=yellow_marker[1]
                                                ...
                                                #path from red marker to yellow marke
...
cv2.circle(img,(yellow_marker[0],yellow_marker[1]), 5, (255,255,255), -1)
cv2.circle(img,(yellow_bed[0],yellow_bed[1]), 5, (255,255,255), -1)
cv2.circle(img,(blue_marker[0],blue_marker[1]), 5, (255,255,255), -1)
cv2.circle(img,(blue_bed[0],blue_bed[1]), 5, (255,255,255), -1)
cv2.circle(img,(red_marker[0],red_marker[1]), 5, (255,255,255), -1)
cv2.circle(img,(red_bed[0],red_bed[1]), 5, (255,255,255), -1)



#obstacles
cv2.circle(img,(320,160), 5, (0,0,0), -1)
cv2.circle(img,(320,120), 5, (0,0,0), -1)
cv2.circle(img,(240,160), 5, (0,0,0), -1)
cv2.circle(img,(200,160), 5, (0,0,0), -1)
cv2.circle(img,(320,240), 5, (0,0,0), -1)
cv2.circle(img,(320,320), 5, (0,0,0), -1)
cv2.circle(img,(200,240), 5, (0,0,0), -1)
cv2.circle(img,(200,320), 5, (0,0,0), -1)
cv2.circle(img,(240,240), 5, (0,0,0), -1)
cv2.circle(img,(200,400), 5, (0,0,0), -1)
cv2.circle(img,(240,400), 5, (0,0,0), -1)
cv2.circle(img,(320,400), 5, (0,0,0), -1)
cv2.circle(img,(360,400), 5, (0,0,0), -1)
