...
def bot_path_2coloursame(cx1,cy1,b1,r1,y1):
...
def bot_path_3coloursame(cx1,cy1,b1,r1,y1):
...
if(b1==4)|(r1==4)|(y1==4):
    bot_path_2coloursame(cx1,cy1,b1,r1,y1)
elif(b1==6)|(r1==6)|(y1==6):
    bot_path_3coloursame(cx1,cy1,b1,r1,y1)
#elif(b1==2)&(r1==2)&(y1==2):
#    bot_path_all_different(cx1,cy1,b1,r1,y1)


order_demand=[]    
if(red_bed[1]<blue_bed[1]):
    if(yellow_bed[1]<red_bed[1]):
        order_demand.append(yellow_bed[0])
        order_demand.append(yellow_bed[1])
        order_demand.append(red_bed[0])
        order_demand.append(red_bed[1])
        order_demand.append(blue_bed[0])
        order_demand.append(blue_bed[1])
        
        order_demand.append(yellow_marker[0])
        order_demand.append(yellow_marker[1])
        order_demand.append(red_marker[0])
        order_demand.append(red_marker[1])
        order_demand.append(blue_marker[0])
        order_demand.append(blue_marker[1])
    elif(yellow_bed[1]>red_bed[1]):
        if(blue_bed[1]>yellow_bed[1]):
            order_demand.append(red_bed[0])
            order_demand.append(red_bed[1])
            order_demand.append(yellow_bed[0])
            order_demand.append(yellow_bed[1])
            ...
            order_demand.append(yellow_marker[0])
            order_demand.append(yellow_marker[1])
elif(red_bed[1]>blue_bed[1]):
    if(yellow_bed[1]<blue_bed[1]):
        order_demand.append(yellow_bed[0])
        order_demand.append(yellow_bed[1])
        order_demand.append(blue_bed[0])
        order_demand.append(blue_bed[1])
        ...
        order_demand.append(red_marker[0])
        order_demand.append(red_marker[1])
    elif(yellow_bed[1]>blue_bed[1]):
        if(red_bed[1]>yellow_bed[1]):
            order_demand.append(blue_bed[0])
            order_demand.append(blue_bed[1])
            order_demand.append(yellow_bed[0])
            order_demand.append(yellow_bed[1])
