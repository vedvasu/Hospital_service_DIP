        ...
        for z2 in range (x,y):
            ...
            if (cxa<400)&(cya<400):
                ...
                if (cxa+40)<400:
                    ...
                    bx1=255
                #print b1
                if (t1!=1)&(cxa>0)&(cya>0)&(b1==255)&(bx1>100):
                    path1.append(layer1)
                    #print path1
            ...
            if (cxb<400)&(cyb<400):
                ...
                if (cxb+40)<400:
                    bx2,gx2,rx2 = blur[cyb,cxb+20]
                else:
                    bx2=255     
                #print b2
                if (t2!=1)&(cxb>0)&(cyb>0)&(b2==255)&(bx2>100):
                    path2.append(layer2)
                    #print path2
            ...
            if (cxc<400)&(cyc<400):        
                ...
                if (cxc+40)<400:
                    bx3,gx3,rx3 = blur[cyc,cxc+20]
                else:
                    bx3=255
                #print b3
                if (t3!=1)&(cxc>0)&(cyc>0)&(b3==255)&(bx2>100):
                    path3.append(layer3)
                    #print path3
            ...
            if (cxd<400)&(cyd<400):    
                ...
                if (cxd+40)<400:
                    bx4,gx4,rx4 = blur[cyd,cxd+20]
                else:
                    bx4=255
                #print b4
                if (t4!=1)&(cxd>0)&(cyd>0)&(b4==255)&(bx2>100):
                    path4.append(layer4)
                    #print path4
...
ret,thresh = cv2.threshold(thresh2,150,255,cv2.THRESH_BINARY_INV)
...
cx2=cbx2
cy2=cby2
#d=get_shortestpath(cbotx,cboty,cx1,cy1,d)
...
cx2=crx2
cy2=cry2
#get_shortestpath(cx1,cy1,cx2,cy2,d)
############################################
## Show the image
